...
void main() {
  group("Mock Authentication", () {
    ...
    test(
      "Should be able to initialize in less thn 2 seconds",
      () async {
        await provider.initialize();
        expect(provider.isInitialized, true);
      },
    ...
    test("Login user should be get verified", () {
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({
    ...
    if (password == 'foobar123') throw WrongPasswordAuthException();
